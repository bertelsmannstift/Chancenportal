...
return [
    ...
    'columns' => [
        ...
        'address_type' => [
            'exclude' => true,
            'label' => 'LLL:EXT:chancenportal/Resources/Private/Language/locallang_db.xlf:tx_chancenportal_domain_model_offer.address_type',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
        ...
        'next_calculated_date' => [
            'exclude' => true,
            'label' => 'LLL:EXT:chancenportal/Resources/Private/Language/locallang_db.xlf:tx_chancenportal_domain_model_offer.next_calculated_date',
            'config' => [
                'dbType' => 'datetime',
                'type' => 'input',
                'renderType' => 'inputDateTime',
